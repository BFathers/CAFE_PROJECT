...
public class CAFE_OVERALL {
 ...
 /* 회원가입시 CUSTOMER 테이블의 CUSTID와 STAMP 테이블의 STAMPID, CUSTID
    COUPON 테이블의 STAMPID를 1을 넣어주고 회원가입할때마다 1씩 증가 [COUPON 테이블 COUPONCNT는 0, COUPONID는 NULL]*/
    
    // 2.회원 가입 (CUSTID(초기값 1 자동입력), CUSTNAME, PASSWORD, PHONENUMBER 차례대로 입력)
...
//--------회원 조회, 수정 및 비활성화, 활성화 그리고 STAMPCNT, COUPONCNT 값 가져와 OR 조건으로 0이상이면 탈퇴 Y 입력시 0으로 둘다 초기화 
	...
	// 회원 활성화 (INACTIVE 를 ACTIVE로 상태변경)
